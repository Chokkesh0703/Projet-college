...
const Studentchatroomroutes = Router();

// Create a new chatroom
Studentchatroomroutes.post('/create', authenticate, async (req, res) => {
...
Studentchatroomroutes.get('/all/:facultyId', async (req, res) => {
...
Studentchatroomroutes.get('/student/:studentId', async (req, res) => {
...
Studentchatroomroutes.post('/send_message', authenticate, async (req, res) => {
...
Studentchatroomroutes.post('/mark_as_read', authenticate, async (req, res) => {
...
export default Studentchatroomroutes;
