...
//                     <Tabs style={{ width: 'inherit', display: 'flex', justifyContent: 'center', alignItems: 'center' }} value={value} onChange={handleChange} aria-label="basic tabs example">
//                         <Tab label="Home" {...a11yProps(0)} />
//                         <Tab label="Faculty Details" {...a11yProps(1)} />
//                         <Tab label="Faculty Chat" {...a11yProps(2)} />
//                         <Tab label="Chatroom" {...a11yProps(3)} />
//                     </Tabs>
//                 </Box>
//                 <CustomTabPanel value={value} index={0}>
